...
const GOAL_Y = 40;
const QUESTION_Y = 140;
const ANSWER_Y = 250;
const RESULT_Y = 390;
const NODE_RX = 10;
const NODE_HEIGHT = 36;

// Question nodes spread across width
const QUESTIONS = [
      ...
      >
        ...
        {QUESTIONS.map((q, i) => {
          ...
          return (
            <path
              key={`line-goal-${q.id}`}
              d={makeCurvedPath(GOAL_NODE.x, GOAL_Y + NODE_HEIGHT / 2 + 4, q.x, QUESTION_Y - NODE_HEIGHT / 2 - 2)}
              fill="none"
              stroke={NAVY}
              strokeWidth={1.5}
              strokeDasharray="4 3"
        ...
        {ANSWERS.map((a, i) => {
          ...
          return (
            <path
              key={`line-q-${a.id}`}
              d={makeCurvedPath(QUESTIONS[i].x, QUESTION_Y + NODE_HEIGHT / 2 + 2, a.x, ANSWER_Y - NODE_HEIGHT / 2 - 2)}
              fill="none"
              stroke={TEAL}
              strokeWidth={1.5}
              strokeDasharray="4 3"
        ...
        {ANSWERS.map((a, i) => {
          ...
          return (
            <path
              key={`line-a-${a.id}`}
              d={makeCurvedPath(a.x, ANSWER_Y + NODE_HEIGHT / 2 + 2, RESULT_NODE.x, RESULT_Y - NODE_HEIGHT / 2 - 2)}
              fill="none"
              stroke={NAVY}
              strokeWidth={1.5}
              strokeDasharray="4 3"
